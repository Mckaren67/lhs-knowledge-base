...
Fill **3 open Residential House Cleaner positions** by **May 1, 2026**.

| Role | Vacated by | Date | Priority |
|---|---|---|---|
| Residential House Cleaner | Lorissa W | March 26, 2026 | Urgent |
| Residential House Cleaner | Julieta S | March 26, 2026 | Urgent |
| Residential House Cleaner | Paula | April 16, 2026 (no notice) | Urgent |

Active modified role: **Alissa** — on hospital leave; handling with care.
...
## Screener requirements (Indeed)

1. 1+ year of cleaning experience — required
2. Located in Chilliwack, BC V2R 1A1 — required
3. Willing to travel up to 75% — required
4. Provide 2–3 interview date/time options — required
